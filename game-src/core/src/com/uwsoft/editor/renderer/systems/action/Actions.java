...
public class Actions {
    ...
    private static void initialize() throws /*dim InstantiationException,*/ IllegalAccessException {
        GwtChange.fixed();//InstantiationException
    ...
    public static <T extends ActionLogic> void registerActionClass(Class<T> type) throws IllegalAccessException {
//        if (!actionLogicMap.containsKey(type.getName())) {
//            actionLogicMap.put(type.getName(), type.newInstance());
//        }
        throw new RuntimeException(GwtChange.fixed());
    }
